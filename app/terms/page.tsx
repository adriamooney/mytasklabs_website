  ...
  return (
    <div className="min-h-screen bg-slate-50 py-20 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mt-2 text-slate-500 text-sm">Effective Date: Sept 6, 2024</p>
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-slate-600 leading-relaxed">You agree to:</p>
        ...
        <section className="mt-8">
          ...
          <address className="mt-2 text-slate-600 leading-relaxed not-italic">
            My Task Labs, LLC
            <br />
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 font-medium text-slate-900">STOP</p>
          <p className="mt-2 text-slate-600 leading-relaxed">
          ...
          <p className="mt-2 font-medium text-slate-900">HELP</p>
